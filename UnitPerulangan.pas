...
type
  TForm6Perulangan_P3 = class(TForm)
    lbl1: TLabel;
    edt1: TEdit;
    btn1: TButton;
...
var
  Form6Perulangan_P3: TForm6Perulangan_P3;

implementation

{$R *.dfm}

procedure TForm6Perulangan_P3.btn1Click(Sender: TObject);
var
  n,i:Integer;
begin
...
procedure TForm6Perulangan_P3.FormShow(Sender: TObject);
begin
strngrd1.ColCount:=5;
